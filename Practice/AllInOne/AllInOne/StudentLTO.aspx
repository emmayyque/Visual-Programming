<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentLTO.aspx.cs" Inherits="AllInOne.StudentLTO" %>
...
<body>
    <div class="container mt-4">
        <form id="form1" runat="server">
            <h2 class="display-6 fw-bolder text-center text-light bg-dark p-3">Student Form (LTO)</h2>
