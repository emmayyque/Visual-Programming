<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentLTX.aspx.cs" Inherits="AllInOne.StudentLTX" %>
...
<body>
    <div class="container mt-4">
        <form id="form1" runat="server">
            <h2 class="display-6 fw-bolder text-center text-light bg-dark p-3">Student Form (LTX)</h2>
            ...
            <div class="my-2 form-group">
                <asp:Label ID="LabId" runat="server" Text="Student ID"></asp:Label>
