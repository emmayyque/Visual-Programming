<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="EmployeePanel.aspx.cs" Inherits="Auth_AuthCLA.EmployeePanel" %>
    ...
    <div class="container mt-3">
        <form id="form1" runat="server">
            <div class="card border-1 shadow-lg p-3">
                <h2 class="display-6 fw-bolder text-center text-light bg-dark p-2">Employee Panel</h2>
