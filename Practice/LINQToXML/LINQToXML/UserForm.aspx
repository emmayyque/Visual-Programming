<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserForm.aspx.cs" Inherits="LINQToXML.UserForm" %>
        ...
        <form id="form1" runat="server">
            <div class="card p-3">
                ...
                <div class="my-2 d-flex justify-content-center align-item-center gap-3">
                    ...
                    <asp:Button ID="BtnReset" runat="server" Text="Reset" CssClass="btn btn-warning text-white" OnClick="BtnReset_Click"/>
                </div>
            </div>
            <div class="mt-4">
