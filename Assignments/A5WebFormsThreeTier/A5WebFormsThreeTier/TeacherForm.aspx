<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherForm.aspx.cs" Inherits="A5WebFormsThreeTier.TeacherForm" %>
...
<body>
    <div class="container">
        ...
        <form id="form1" runat="server" class="w-100 mx-auto mt-4 d-flex align-items-start justify-content-center gap-3">
            ...
            <div class="col-6">
                <asp:Button ID="BtnMain" runat="server" CssClass="btn btn-primary mb-3 text-right" Text="Main Page" OnClick="BtnMain_Click" />
