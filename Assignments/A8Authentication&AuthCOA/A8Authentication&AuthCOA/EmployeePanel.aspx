<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="EmployeePanel.aspx.cs" Inherits="A8Authentication_AuthCOA.EmployeePanel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitle" runat="server">
    Employee Panel
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
    <div class="container mt-5">
        <h2 class="display-4 text-center text-dark fw-bolder my-4">Employee Panel</h2>
